...
def populate():
    action_movies = [
        {'title': 'The Dark Knight', 'year': '2008', 'movieid': '1',
         'url': 'https://www.imdb.com/title/tt0468569/?ref_=adv_li_tt', 'movie_likes': '45', 'views': '253', 
        ...
        {'title': 'The Lord of the Rings: The Return of the King', 'year': '2003', 'movieid': '2',
         'url': 'https://www.imdb.com/title/tt0167260/?ref_=adv_li_tt', 'movie_likes': '74', 'views': '366',
        ...
        {'title': 'Inception', 'year': '2010', 'movieid': '3',
         'url': 'https://www.imdb.com/title/tt1375666/?ref_=adv_li_tt', 'movie_likes': '35', 'views': '767',
        ...
        {'title': 'The Lord of the Rings: The Fellowship of the Ring', 'year': '2001', 'movieid': '4',
         'url': 'https://www.imdb.com/title/tt0120737/?ref_=adv_li_tt', 'movie_likes': '34', 'views': '678',
        ...
        {'title': 'Brothers in Arms', 'year': '2016', 'movieid': '5',
         'url': 'https://www.imdb.com/title/tt5813916/?ref_=adv_li_tt', 'movie_likes': '65', 'views': '467', 
    ...
    musical_movies = [
        {'title': 'The Lion King', 'year': '1994', 'movieid': '6',
         'url': 'https://www.imdb.com/title/tt0110357/?ref_=adv_li_tt', 'movie_likes': '23', 'views': '126',
        ...
        {'title': 'Hamilton', 'year': '2020', 'movieid': '7',
         'url': 'https://www.imdb.com/title/tt8503618/?ref_=adv_li_tt', 'movie_likes': '75', 'views': '245', 
        ...
        {'title': 'Anand', 'year': '2010', 'movieid': '8',
         'url': 'https://www.imdb.com/title/tt0066763/?ref_=adv_li_tt', 'movie_likes': '64', 'views': '253',
        ...
        {'title': 'Singin\' in the Rain', 'year': '1952', 'movieid': '9',
         'url': 'https://www.imdb.com/title/tt0045152/?ref_=adv_li_tt', 'movie_likes': '38', 'views': '658',
         'story': 'A silent film production company and cast make a difficult transition to sound.'},

        {'title': 'Sholay', 'year': '1975', 'movieid': '10',
         'url': 'https://www.imdb.com/title/tt0073707/?ref_=adv_li_tt', 'movie_likes': '35', 'views': '456',
    ...
    romance_movies = [
        {'title': 'Forrest Gump', 'year': '1994', 'movieid': '11',
         'url': 'https://www.imdb.com/title/tt0109830/?ref_=adv_li_tt', 'movie_likes': '84', 'views': '366',
        ...
        {'title': 'Life Is Beautiful', 'year': '1997', 'movieid': '12',
         'url': 'https://www.imdb.com/title/tt0118799/?ref_=adv_li_tt', 'movie_likes': '84', 'views': '364', 
        ...
        {'title': 'Cinema Paradiso', 'year': '1988', 'movieid': '13',
         'url': 'https://www.imdb.com/title/tt0095765/?ref_=adv_li_tt', 'movie_likes': '34', 'views': '667',
        ...
        {'title': 'Casablanca', 'year': '1942', 'movieid': '14',
         'url': 'https://www.imdb.com/title/tt0034583/?ref_=adv_li_tt', 'movie_likes': '36', 'views': '376',
        ...
        {'title': 'Modern Times', 'year': '1936', 'movieid': '15',
         'url': 'https://www.imdb.com/title/tt0027977/?ref_=adv_li_tt', 'movie_likes': '95', 'views': '458',
    ...
    sport_movies = [
        {'title': 'Dangal', 'year': '2016', 'movieid': '16',
         'url': 'https://www.imdb.com/title/tt5074352/?ref_=adv_li_tt', 'movie_likes': '34', 'views': '843',
        ...
        {'title': 'Children of Heaven', 'year': '1997', 'movieid': '17',
         'url': 'https://www.imdb.com/title/tt0118849/?ref_=adv_li_tt', 'movie_likes': '53', 'views': '496', 
        ...
        {'title': 'Bhaag Milkha Bhaag', 'year': '2013', 'movieid': '18',
         'url': 'https://www.imdb.com/title/tt2356180/?ref_=adv_li_tt', 'movie_likes': '25', 'views': '569',
        ...
        {'title': 'Paan Singh Tomar', 'year': '2012', 'movieid': '19',
         'url': 'https://www.imdb.com/title/tt1620933/?ref_=adv_li_tt', 'movie_likes': '95', 'views': '758',
        ...
        {'title': 'Chak De! India', 'year': '2007', 'movieid': '20',
         'url': 'https://www.imdb.com/title/tt0871510/?ref_=adv_li_tt', 'movie_likes': '75', 'views': '564',
    ...
    for cat, cat_data in cats.items():  
        ...
        for p in cat_data['movies']:
            add_movie(c, p['title'], p['year'], p['movieid'], p['url'],
                      p['movie_likes'], p['views'], p['story'])
...
def add_movie(cat, title, year, movieid, url, movie_likes, views, story): 
